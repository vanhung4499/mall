...
public class PmsProductAttributeCategoryController {
    ...
    @ApiOperation("Update Product Attribute Category")
    ...
    @ApiOperation("Delete Single Product Attribute Category")
    ...
    @ApiOperation("Get Single Product Attribute Category Information")
    @GetMapping(value = "/{id}")
    @ResponseBody
    ...
    @ApiOperation("Get All Product Attribute Categories in Pages")
