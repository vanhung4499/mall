...
@Tag(name = "SmsFlashPromotionSessionController", description = "Flash Sale Session Management")
@RequestMapping("/flashSession")
public class SmsFlashPromotionSessionController {
    @Autowired
    private SmsFlashPromotionSessionService flashPromotionSessionService;

    @ApiOperation("Add session")
    ...
    @ApiOperation("Update activation status")
    ...
    @ApiOperation("Get all available sessions and their counts")
