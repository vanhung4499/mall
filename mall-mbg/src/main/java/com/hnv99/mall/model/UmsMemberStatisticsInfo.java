...
public class UmsMemberStatisticsInfo implements Serializable {
    ...
    @ApiModelProperty(value = "Total Consumption Amount")
    ...
    @ApiModelProperty(value = "Follow Count")
    private Integer attendCount;

    @ApiModelProperty(value = "Fan Count")
    private Integer fansCount;

    @ApiModelProperty(value = "Product Collection Count")
    private Integer collectProductCount;

    @ApiModelProperty(value = "Subject Collection Count")
    private Integer collectSubjectCount;

    @ApiModelProperty(value = "Topic Collection Count")
    private Integer collectTopicCount;

    @ApiModelProperty(value = "Comment Collection Count")
    private Integer collectCommentCount;

    @ApiModelProperty(value = "Invite Friend Count")
