...
public class OmsOrder implements Serializable {
    ...
    @ApiModelProperty(value = "Payable amount (actual payment amount)")
    ...
    @ApiModelProperty(value = "Discount amount used by the administrator to adjust the order in the background")
    ...
    @ApiModelProperty(value = "Points that can be obtained")
    private Integer integration;

    @ApiModelProperty(value = "Growth value that can be obtained")
    private Integer growth;

    @ApiModelProperty(value = "Promotion information")
    ...
    @ApiModelProperty(value = "Invoice receiver's phone")
    private String billReceiverPhone;

    @ApiModelProperty(value = "Invoice receiver's email")
    private String billReceiverEmail;

    @ApiModelProperty(value = "Receiver's name")
    private String receiverName;

    @ApiModelProperty(value = "Receiver's phone")
    private String receiverPhone;

    @ApiModelProperty(value = "Receiver's postal code")
    ...
    @ApiModelProperty(value = "Confirmation status: 0->Not confirmed; 1->Confirmed")
    private Integer confirmStatus;

    @ApiModelProperty(value = "Delete status: 0->Not deleted; 1->Deleted")
    private Integer deleteStatus;

    @ApiModelProperty(value = "Points used when placing the order")
    ...
    @ApiModelProperty(value = "Confirmation of receipt time")
