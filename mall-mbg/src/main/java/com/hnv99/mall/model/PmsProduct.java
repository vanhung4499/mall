...
public class PmsProduct implements Serializable {
    ...
    @ApiModelProperty(value = "Publish status: 0->Unpublished; 1->Published")
    private Integer publishStatus;

    @ApiModelProperty(value = "New product status: 0->Not new; 1->New")
    private Integer newStatus;

    @ApiModelProperty(value = "Recommend status: 0->Not recommended; 1->Recommended")
    ...
    @ApiModelProperty(value = "Limit of points usage")
    ...
    @ApiModelProperty(value = "Stock alert value")
    private Integer lowStock;

    @ApiModelProperty(value = "Unit")
    private String unit;

    @ApiModelProperty(value = "Product weight, default in grams")
    private BigDecimal weight;

    @ApiModelProperty(value = "Preview product status: 0->Not a preview; 1->Preview")
    private Integer previewStatus;

    @ApiModelProperty(value = "Product services split by comma: 1->No worry return; 2->Fast refund; 3->Free shipping")
    ...
    @ApiModelProperty(value = "Album pictures, limit to 5 pictures, split by comma")
    ...
    @ApiModelProperty(value = "Promotion limit quantity")
    private Integer promotionPerLimit;

    @ApiModelProperty(value = "Promotion type: 0->No promotion use original price; 1->Use promotion price; 2->Use member price; 3->Use ladder price; 4->Use full reduction price; 5->Flash sale")
    ...
    @ApiModelProperty(value = "Product detail webpage content")
    private String detailHtml;

    @ApiModelProperty(value = "Mobile webpage detail")
