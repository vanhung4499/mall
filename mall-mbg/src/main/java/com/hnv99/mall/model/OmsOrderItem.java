...
public class OmsOrderItem implements Serializable {
    ...
    @ApiModelProperty(value = "Product promotion decomposition amount")
    private BigDecimal promotionAmount;

    @ApiModelProperty(value = "Coupon discount decomposition amount")
    private BigDecimal couponAmount;

    @ApiModelProperty(value = "Points discount decomposition amount")
    private BigDecimal integrationAmount;

    @ApiModelProperty(value = "The decomposition amount of this product after discount")
    ...
    @ApiModelProperty(value = "Product sales attributes: [{'key':'Color','value':'Color'},{'key':'Capacity','value':'4G'}]")
