...
public class OmsOrderReturnApply implements Serializable {
    ...
    @ApiModelProperty(value = "Receiving address table id")
    ...
    @ApiModelProperty(value = "Returner name")
    ...
    @ApiModelProperty(value = "Product sale attributes: Color: Red; Size: XL;")
    ...
    @ApiModelProperty(value = "Processing note")
    private String handleNote;

    @ApiModelProperty(value = "Processing person")
    private String handleMan;

    @ApiModelProperty(value = "Receiver")
    private String receiveMan;

    @ApiModelProperty(value = "Receiving time")
    private Date receiveTime;

    @ApiModelProperty(value = "Receiving note")
