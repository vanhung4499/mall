...
public class SmsCoupon implements Serializable {
    ...
    @ApiModelProperty(value = "Coupon type; 0->Full gift coupon; 1->Member gift coupon; 2->Shopping gift coupon; 3->Registration gift coupon")
    ...
    @ApiModelProperty(value = "Use type: 0->Universal; 1->Designated category; 2->Designated product")
    private Integer useType;

    @ApiModelProperty(value = "Note")
    private String note;

    @ApiModelProperty(value = "Issued quantity")
    ...
    @ApiModelProperty(value = "Date when it can be received")
    private Date enableTime;

    @ApiModelProperty(value = "Coupon code")
    private String code;

    @ApiModelProperty(value = "Member level that can receive: 0->Unlimited")
