...
public class OmsCompanyAddress implements Serializable {
    ...
    @ApiModelProperty(value = "Is it the default receiving address: 0->No; 1->Yes")
    private Integer receiveStatus;

    @ApiModelProperty(value = "Name of the receiver/sender")
    private String name;

    @ApiModelProperty(value = "Receiver's phone number")
