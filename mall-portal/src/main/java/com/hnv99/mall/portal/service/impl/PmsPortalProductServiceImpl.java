...
public class PmsPortalProductServiceImpl implements PmsPortalProductService {
    ...
    public List<PmsProduct> search(String keyword, Long brandId, Long productCategoryId, Integer pageNum, Integer pageSize, Integer sort) {
        ...
        //1->sort by new products; 2->sort by sales volume; 3->price from low to high; 4->price from high to low
        if (sort == 1) {
    ...
    public PmsPortalProductDetail detail(Long id) {
        ...
        // Get product SKU stock information
        ...
        // Product full reduction price setting
        ...
        // Available coupons for the product
        result.setCouponList(portalProductDao.getAvailableCouponList(product.getId(),product.getProductCategoryId()));
        return result;
    }

    /**
     * Convert initial object to node object
     */
